"""Vercel serverless entrypoint for AlphaForge API."""
...
async def root():
    return {
        "name": "AlphaForge API",
        "version": "0.1.0",
        "status": "running (serverless mode)",
        "docs": "/api/docs",
    }
...
async def market_latest():
    """Stub — returns empty market data."""
...
async def list_strategies():
    ...
    return {"strategies": [], "total": 0, "note": "Connect PostgreSQL for real data"}


@app.get("/api/v1/signals")
async def list_signals():
    """Stub — no database connected."""
    return {"signals": [], "total": 0, "note": "Connect PostgreSQL for real data"}


@app.get("/api/v1/backtests")
async def list_backtests():
    """Stub — no database connected."""
    return {"backtests": [], "total": 0, "note": "Connect PostgreSQL for real data"}


@app.get("/api/v1/alerts")
async def list_alerts():
    """Stub — no database connected."""
    return {"alerts": [], "total": 0, "note": "Connect PostgreSQL for real data"}


@app.get("/api/v1/audits")
async def list_audits():
    """Stub — no database connected."""
    return {"audits": [], "total": 0, "note": "Connect PostgreSQL for real data"}


@app.post("/api/v1/auth/login")
async def login_stub():
    """Stub — auth not available in serverless mode."""
    return {"error": "Authentication requires PostgreSQL. Deploy full backend for auth.", "status": "unavailable"}


@app.get("/api/v1/market/candles")
async def market_candles():
    """Stub — returns empty candles."""
    return {"symbol": "ETH/USD", "interval": "1h", "candles": []}


@app.get("/api/v1/market/orderbook")
async def market_orderbook():
    """Stub — returns empty orderbook."""
