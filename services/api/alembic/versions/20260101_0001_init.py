...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("requested_by", postgresql.UUID(as_uuid=False), sa.ForeignKey("users.id"), nullable=False),
    ...
    op.create_table(
        "backtest_trades",
        sa.Column("id", postgresql.UUID(as_uuid=False), primary_key=True),
        sa.Column("backtest_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("backtests.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        "signals",
        sa.Column("id", postgresql.UUID(as_uuid=False), primary_key=True),
        sa.Column("strategy_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("strategies.id"), nullable=False),
    ...
    op.create_table(
        "alert_deliveries",
        sa.Column("id", postgresql.UUID(as_uuid=False), primary_key=True),
        sa.Column("alert_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("alerts.id", ondelete="CASCADE"), nullable=False),
...
def downgrade() -> None:
    for tbl in (
        "audit_jobs", "alert_deliveries", "alerts", "signals",
        "backtest_trades", "backtests", "strategy_versions",
        "strategies", "api_keys", "users",
    ):
        op.drop_table(tbl)
