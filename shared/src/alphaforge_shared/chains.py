...
CHAINS: tuple[ChainSpec, ...] = (
    ChainSpec(
        ...
        finality_blocks=12,
        rpc_http_env="ETH_RPC_HTTP",
        rpc_ws_env="ETH_RPC_WS",
    ...
    ChainSpec(
        ...
        finality_blocks=15,
        rpc_http_env="BSC_RPC_HTTP",
        rpc_ws_env="BSC_RPC_WS",
    ...
    ChainSpec(
        ...
        finality_blocks=128,
        rpc_http_env="POLYGON_RPC_HTTP",
        rpc_ws_env="POLYGON_RPC_WS",
    ...
    ChainSpec(
        ...
        finality_blocks=20,
        rpc_http_env="ARBITRUM_RPC_HTTP",
        rpc_ws_env="ARBITRUM_RPC_WS",
    ...
    ChainSpec(
        ...
        block_time_seconds=2.0,
        finality_blocks=20,
        rpc_http_env="BASE_RPC_HTTP",
        rpc_ws_env="BASE_RPC_WS",
    ...
    ChainSpec(
        ...
        block_time_seconds=2.0,
        finality_blocks=20,
        rpc_http_env="OPTIMISM_RPC_HTTP",
        rpc_ws_env="OPTIMISM_RPC_WS",
    ...
    ChainSpec(
        ...
        block_time_seconds=2.0,
        finality_blocks=20,
        rpc_http_env="AVALANCHE_RPC_HTTP",
        rpc_ws_env="AVALANCHE_RPC_WS",
    ...
    ChainSpec(
        ...
        finality_blocks=32,
        rpc_http_env="SOLANA_RPC_HTTP",
        rpc_ws_env="SOLANA_RPC_WS",
    ...
    ChainSpec(
        ...
        finality_blocks=1,
        rpc_http_env="COSMOS_RPC_HTTP",
        rpc_ws_env="COSMOS_RPC_HTTP",
        explorer_api_env=None,
        dexes=("osmosis",),
    ),
)
